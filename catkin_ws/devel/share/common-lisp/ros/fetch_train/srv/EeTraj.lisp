...
(cl:defmethod cl:initialize-instance :after ((m <EeTraj-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EeTraj-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fetch_train-srv:<EeTraj-request> is deprecated: use fetch_train-srv:EeTraj-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <EeTraj-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fetch_train-srv:pose-val is deprecated.  Use fetch_train-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <EeTraj-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EeTraj-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fetch_train-srv:<EeTraj-response> is deprecated: use fetch_train-srv:EeTraj-response instead.")))
