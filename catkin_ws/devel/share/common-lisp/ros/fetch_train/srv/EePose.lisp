...
(cl:defmethod cl:initialize-instance :after ((m <EePose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EePose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fetch_train-srv:<EePose-request> is deprecated: use fetch_train-srv:EePose-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <EePose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EePose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fetch_train-srv:<EePose-response> is deprecated: use fetch_train-srv:EePose-response instead.")))
